...
"dojo/dom-attr",
 ...
 "dojo/_base/sniff"], function(
  ...
  var _TOCNode = declare([_Widget, _Templated],{
    ...
    '<span data-dojo-attach-event="onclick:_onClicka" style="cursor:pointer"><img src="../pukaltim/images/nav_zoomin.png" /></span>'+
    ...
    _onClicka: function(evt){
      
     var mx = new Point(116.5, 0.2);
      map.centerAndZoom(mx,8);
    },
 ...
 var _RootLayerTOC = declare([_Widget], {
  ...
  var TOC = declare("agsjs.TOC", [_Widget, Evented],{
    indentSize: 18,
    swatchSize: [30, 30],
    refreshDelay: 500,
    layerInfos: null,
